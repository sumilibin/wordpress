jQuery(document).ready(function($) {
    'use strict';
    var this_obj = hairstylist_salon_plugin_activate_plugin;

    $('#wpelemento_importer_editor .plugin-activation-redirect a').addClass('wpi-redirect-to-dashboard');

    $(document).on('click', '.hairstylist-salon-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message hairstylist-salon-plugin-install');
                button.addClass('button-primary hairstylist-salon-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.hairstylist-salon-recommended-plugins .hairstylist-salon-activation-note').css('display','block');
    ...
    $(document).on('click', '.hairstylist-salon-plugin-activate', function(event) {
